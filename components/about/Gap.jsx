      ...
      <div className="">
        ...
        <div className="grid grid-cols-1 grid-rows-[1fr_1fr_1fr]  gap-3 md:grid-rows-[1fr_1fr_1fr_1fr_1fr] md:grid-cols-2  md:gap-10">
            <div 
              ...
              className={` rounded-[6px] 2xl:rounded-[17px] bg-primary p-6 md:p-8 lg:p-[60px] lg:pb-[30px] 2xl:p-[max(0.5px,0.0416233*(100vw-17px))] 2xl:pb-[max(0.5px,0.0208118*(100vw-17px))] text-white border border-white  transition-all duration-300  md:row-start-1 md:row-span-1  md:col-span-1 sticky top-[160px] `}
            >
        ...
        data and analytics solutions, governance frameworks, and technology implementations.
            ...
            <div 
              ...
              className={` rounded-[6px] 2xl:rounded-[17px] p-6 md:p-8 lg:p-[60px] lg:pb-[30px] 2xl:p-[max(0.5px,0.0416233*(100vw-17px))] 2xl:pb-[max(0.5px,0.0208118*(100vw-17px))] bg-primary text-white border border-white  transition-all duration-300  md:row-start-3 md:row-span-1 md:col-start-2 md:col-span-1 sticky top-[160px] `}
            >
        ...
        <div
          ...
          className="relative rounded-[6px] 2xl:rounded-[17px]   py-16 px-8 2xl:pb-[max(0.5px,0.0208117*(100vw-17px))] flex flex-col items-center justify-center text-center min-h-[200px] gap-bg md:row-start-5 md:col-span-2 sticky top-[160px]"
        >
          {/* animated globes */}
