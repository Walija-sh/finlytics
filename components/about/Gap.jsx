      ...
      <div className="">
        ...
        <div className="grid grid-cols-1 grid-rows-[1fr_1fr_1fr]  gap-3 md:grid-rows-[1fr_1fr_1fr_1fr_1fr] md:grid-cols-2  md:gap-10">
            <div 
              ...
              className={` rounded-[6px] bg-primary p-6 md:p-8 lg:p-[60px] lg:pb-[30px] text-white border border-white  transition-all duration-300  md:row-start-1 md:row-span-1  md:col-span-1 sticky top-[160px]`}
            >
              <div className="w-[13.469817%] md:w-[8.946356805871046%] lg:w-[7.4667786683466915%] h-auto mb-2 md:mb-[22px]">
        ...
        data and analytics solutions, governance frameworks, and technology implementations.
            ...
            <div 
              ...
              className={` rounded-[6px] p-6 md:p-8 lg:p-[60px] lg:pb-[30px] bg-primary text-white border border-white  transition-all duration-300  md:row-start-3 md:row-span-1 md:col-start-2 md:col-span-1 sticky top-[160px] `}
            >
              <div className="w-[13.469817%] md:w-[8.946356805871046%] lg:w-[7.4667786683466915%] h-auto mb-1 md:mb-[22px]">
        ...
        <div
          ...
          className="relative rounded-[6px]   py-16 px-8 flex flex-col items-center justify-center text-center min-h-[200px] gap-bg md:row-start-5 md:col-span-2 sticky top-[160px]"
        >
          {/* animated globes */}
          <motion.div className="w-[41.63872251726501%] lg:w-[22.504074265988276%] xl:16.681442224520193% aspect-square absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 " style={{ x: globeX1 }}>
            <Image src='/assets/about/globe.avif' alt='Globes' width={100} height={100} className="w-full h-auto" />
          </motion.div>
          <motion.div className="w-[41.63872251726501%] lg:w-[22.504074265988276%] xl:16.681442224520193% aspect-square absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 " style={{ x: globeX2 }}>
            <Image src='/assets/about/globe.avif' alt='Globes' width={100} height={100} className="w-full h-auto" />
          </motion.div>
          
          
          {/* Content */}
          <motion.p style={{opacity:bannerOpacity}} className="relative z-10 text-white text-[16.401px] md:text-[25px] lg:text-[24px] xl:text-[33.75px] font-bold tracking-wider uppercase">
